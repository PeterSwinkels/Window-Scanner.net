...
Public Class InterfaceWindow
   ...
   'This procedure makes a copy of the window context menu in the menu bar.
   Private Sub CopyWindowContextMenu()
      Try
         Dim Item As ToolStripItem = Nothing
         Dim Items(0 To WindowContextMenu.Items.Count - 1) As ToolStripItem
   ...
   'This procedure sets up the exclude menu.
   Private Sub SetUpExcludeMenu()
      Try
         For Each Item As ToolStripMenuItem In ExcludeMainMenu.DropDownItems
